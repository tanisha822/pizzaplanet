...
class About extends Component{
    ...
    <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
      <div className="col-10 col-sm-8 col-lg-6">
        <img src="https://images.pexels.com/photos/1639565/pexels-photo-1639565.jpeg?auto=compress&cs=tinysrgb&w=600" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy"/>
      </div>
      <div className="col-lg-6">
        <h1 className="display-5 fw-bold text-body-emphasis lh-1 mb-3">Welcome to Our pizza-planet  !</h1>
  ...
  <div className="col">
    <div className="card h-100">
      ...
      <div className="card-body">
        <h5 className="card-title">Detroit Pizza</h5>
      ...
      <div className="card-footer">
        <small className="text-body-secondary">Last updated 45 mins ago</small>
      </div>
    </div>
  </div>
  <div className="col">
  ...
  <div className="col">
    <div className="card h-100">
      <img src="https://images.pexels.com/photos/750073/pexels-photo-750073.jpeg?auto=compress&cs=tinysrgb&w=600" height={300} className="card-img-top" alt="..."/>
      <div className="card-body">
        <h5 className="card-title">Pizzeta</h5>
